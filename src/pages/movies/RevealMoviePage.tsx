// Reveal Movie Page - Standalone turntable effect viewer/recorder
...
import { DEFAULT_CONFIG } from '../../effects/reveal/presets';
...
export const RevealMoviePage: React.FC = () => {
  ...
  const handleRevealSave = (config: RevealConfig) => {
    console.log('🎬 Reveal settings saved:', config);
    setShowRevealModal(false);
    ...
    <div style={{ 
      ...
      <div className="header" style={{
        ...
        <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
          <button
            className="pill"
            onClick={() => { closeAllModals(); setShowRevealModal(true); }}
      ...
      >
        <div style={{ fontSize: '14px', lineHeight: '1.6', color: '#4b5563' }}>
          <p style={{ marginBottom: '16px' }}>
            <strong>Reveal Movie Page:</strong> Create and view 360° rotating animations of puzzle solutions.
          </p>
      ...
      <MovieWhatsNextModal
        ...
        movieTitle={movie?.title || solution?.puzzle_name || 'Reveal Movie'}
        isSaved={(() => {
      ...
      <ShareWelcomeModal
        ...
        movieTitle={movie?.title || 'Reveal Movie'}
      ...
      <ShareOptionsModal
        ...
        shareUrl={`${window.location.origin}/movies/reveal/${savedMovieId || movie?.id || id}?from=share`}
        movieTitle={movie?.title || solution?.puzzle_name || 'Reveal Movie'}
...
export default RevealMoviePage;
