...
function CreatePage() {
  ...
  // Initialize view transforms for the starting sphere
  useEffect(() => {
    // Compute view transforms for the initial single sphere
    const T_ijk_to_xyz = [
      [0.5, 0.5, 0, 0],
      [0.5, 0, 0.5, 0],
      [0, 0.5, 0.5, 0],
    ...
    try {
      ...
      setView(v);
      console.log("✅ Initial view transforms computed for", cells.length, "cells");
    } catch (error) {
      console.error("❌ Failed to compute initial view transforms:", error);
      // Fallback for single sphere
      setView({
        M_world: [
          [1, 0, 0, 0],
          [0, 1, 0, 0],
  ...
  // NOTE: Removed auto-load functionality - Create mode always starts fresh
    ...
    <div className="content-studio-page" style={{ 
      ...
      <div className="shape-header">
        ...
        <div className="header-center" ref={pillbarRef}>
          {/* Always in edit mode - no Load Shape or Done buttons */}
          <button
